...
},
{
  ...
  concepts: ['personal-on-deck-safety'],
  format: 'text',
  prompt: "Beyond the base federal carriage requirement, what rule governs children actually wearing a PFD?",
  choices: [
    { id: 'b', text: "Children are exempt from PFD requirements entirely", whyWrong: "Children are not exempt — federal law adds a wear requirement for young children on top of the carriage requirement that already covers every person aboard." },
    ...
    { id: 'd', text: "PFD wear rules for children are identical nationwide with no state variation", whyWrong: "The federal rule sets an under-13 baseline, but where a state has established its own child PFD wear requirement that state rule applies on its waters instead, so the age threshold is not uniform nationwide." },
    { id: 'a', text: "Federal law requires a child under 13 to wear an approved PFD on a recreational vessel under way unless the child is below decks or in an enclosed cabin — and where a state sets its own child wear age, that state rule applies on its waters instead" },
  ],
  correctChoiceId: 'a',
  explanation: "This is a legal requirement, not just prudent practice. Federal regulation prohibits operating a recreational vessel under way with a child under 13 aboard unless that child is wearing a Coast Guard-approved PFD or is below decks or in an enclosed cabin. Where a state has established its own child PFD wear requirement, the state's rule applies on waters under its jurisdiction in place of the federal one — so check the local age. Either way the device must be sized for the child, not an adult unit.",
  source: '33 CFR 175.15(c) — federal child PFD wear requirement; 33 CFR 175.25 — enforcement of State requirements for children to wear PFDs',
},
{
...
},
{
  ...
  choices: [
    { id: 'c', text: "Preventing a line's end from running out through a block", whyWrong: "That's the role of a stopper knot like a figure-eight; a bowline's purpose is a fixed loop, not blocking a line from running through a fairlead." },
    ...
    { id: 'a', text: "Forming a fixed loop at the end of a line that is usually easy to untie after the load is removed" },
  ...
  correctChoiceId: 'a',
  explanation: "The bowline creates a fixed loop and is usually relatively easy to untie after unloading. It needs correct dressing and adequate tail, and can work loose under cyclic loading or when slack. A common use is an eye around a suitable post or ring; this is not a recommendation for harness or other life-safety attachment.",
  source: 'Animated Knots by Grog — Bowline; Samson Rope — Knots and Hitches; photo provenance: Wikimedia Commons',
},
{
  ...
  topic: 'seamanship-comms',
  format: 'text',
  prompt: "For an ordinary dock line secured to a horn cleat, which pattern makes a proper cleat hitch?",
  choices: [
    ...
    { id: 'a', text: "Lead to the farther horn and around the base, add orderly figure-eight crossings, and finish this dock line with a locking half hitch without piling on excessive turns" },
  ...
  correctChoiceId: 'a',
  explanation: "Lead to the farther horn first and around the base before crossing the horns in a figure-eight pattern. Repeated base turns can trap the incoming line and jam. A locking half hitch finishes an ordinary secured dock line; it is not a universal finish for towlines or other arrangements requiring immediate release.",
  source: 'Animated Knots by Grog — Cleat Hitch (Dock Line); disputed Commons Tied cleat photo omitted',
},
{
...
},
{
  ...
  choices: [
    ...
    { id: 'c', text: "To create a loop for clipping in a safety harness", whyWrong: "This is a stopper, not an attachment loop. Harness and tether connections must follow the equipment manufacturer's instructions; a general-purpose loop knot is not automatically suitable." },
  ...
  source: 'Animated Knots by Grog — Figure 8 Knot and Bowline; ASA 103 standard curriculum — stopper purpose',
},
{
  ...
  choices: [
    { id: 'a', text: "Securely fastening a line to a post, ring, or piling, especially where the round turn can take the initial strain while the half hitches are tied" },
  ...
  correctChoiceId: 'a',
  explanation: "The round turn provides friction around the object, taking the initial strain while the two half hitches secure the end around the standing part. This is a commonly used fastening to a piling, ring, or post; chafe still needs inspection and protection.",
  source: 'Animated Knots by Grog — Round Turn and Two Half Hitches; Samson Rope — rope-use warnings',
},
{
  ...
  choices: [
    ...
    { id: 'a', text: "It can resist slipping along a rod, rail, or another line in the intended direction of pull, more effectively than a plain clove hitch when correctly dressed on suitable materials" },
  ],
  correctChoiceId: 'a',
  explanation: "The rolling hitch adds gripping turns to resist sliding in the intended direction along a rod, rail, or another line. Holding depends on correct dressing, pull direction and compatible materials and diameters; it may slip on modern slippery rope or smooth tubing. Test the actual combination before relying on it.",
  source: 'Animated Knots by Grog — Rolling Hitch (ABOK 1735); photo provenance: Wikimedia Commons',
},
{
